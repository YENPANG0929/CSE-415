...
STARTER CODE Version by Yenpang Huang <- replace with "Version by " [your name]
...
NOUN = ['husky', 'british Shorthair', 'ragdoll', 'birman', 'bulldog', 'shepherd', 'dachshund', 'malamute']
...
ANIMAL_SOUND = ['arf', 'meow', 'woof', 'baa', 'moo', 'cluck', 'chirp', 'quack', 'buzz', 'ribbit']
