...
Student Name 1: Yenpang Huang
Student Name 2: Audrey Gunawan

UW NetID: yph0929 & ajesse
...
class AStar:
    ...
    def AStar(self, initial_state):
        ...
        # STEP 1b. Assign g=0 and to the start state.
        ...
        while len(self.OPEN) > 0:
            ...
            for op in self.Problem.OPERATORS:
                if op.is_applicable(S):
                    ...
                    hs = self.h(new_state)
                    new_f = new_g + hs
                    if new_state in self.CLOSED:    #if new state is in closed list, pull P value
